/*
 * Sideous Umbra - state-variable filter (TPT/Zavalishin topology), switchable
 * lowpass/highpass/bandpass, stable under fast cutoff modulation. Copied
 * verbatim from sideous-noise. Three instances of this in Bandpass mode form
 * the F1/F2/F3 formant bank in MeowVoice.hpp - Lowpass/Highpass go unused
 * here but are kept so the class matches its source verbatim.
 */
